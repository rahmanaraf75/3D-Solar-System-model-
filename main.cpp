...
int main() {
	...
	unsigned int t_sun = loadTexture("resources/planets/7k_sun.jpg");
	...
	unsigned int texture_earth_ring = loadTexture("resources/planets/r.jpg");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		case 0:
			...
			RenderText(TextShader, "SOLAR SYSTEM ", 25.0f, SCREEN_HEIGHT - 30.0f, 0.50f, glm::vec3(0.0f, 0.0f, 1.0f));
